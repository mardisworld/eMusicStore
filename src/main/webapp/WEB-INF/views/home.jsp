        ...
        <div class="item active">
            ...
            <div class="container">
                <div class="carousel-caption">
                    <!--<h1>Marissa Staller's Music Store</h1>
                    <p>Note: If you're viewing this page via a <code>file://</code> URL, the "next" and "previous" Glyphicon buttons on the left and right might not load/display properly due to web browser security rules.</p>
                    <p><a class="btn btn-lg btn-primary" href="#" role="button">Sign up today</a></p>-->


                    <h1>Welcome to Marissa Staller's Music Store</h1>
                    <p>Here you can browse and buy instruments, records, books, and all things related to music. Order now!</p>
                </div>
            </div>
        </div>
        <div class="item">
            ...
            <div class="container">
                <div class="carousel-caption">
                    ...
                    <p><em>lisztomania</em> (n.) the need to listen to music all the time</p>
                </div>
            </div>
        </div>
        <div class="item">
